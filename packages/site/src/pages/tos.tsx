...
const Tos = () => {
    return (
        <div style={textComponent}>
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Plurality.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Terms of Service</strong> (also referred as &quot;Terms&quot;) mean these Terms of Service that form the entire agreement between You and the Company regarding the use of the Service.</p>
            </li>
            <li>
            <p><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p>
            </li>
            <li>
            <p><strong>Website</strong> refers to Plurality, accessible from <a href="https://plurality.westeurope.cloudapp.azure.com" rel="external nofollow noopener" target="_blank">https://plurality.westeurope.cloudapp.azure.com</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: plurality.web3@gmail.com</li>
            </ul>
        </div>
